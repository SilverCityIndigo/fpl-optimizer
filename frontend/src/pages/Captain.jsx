...
export default function Captain() {
  ...
  async function fetchSquad() {
    ...
    try {
      ...
      const captainRes = await getCaptainPick(res.data.player_ids)
      ...
      {step === 3 && picks.length > 0 && (
        <div>
          ...
          <div style={{
            ...
            {picks[0].code && (
              <img
                src={`https://resources.premierleague.com/premierleague/photos/players/110x140/p${picks[0].code}.png`}
                alt={picks[0].web_name}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {picks.map((p, i) => (
              <div key={p.id} style={{
                ...
                <div style={{ color: i === 0 ? '#00ff87' : '#aaa', fontWeight: 'bold', fontSize: '18px', minWidth: '28px' }}>
                  #{i + 1}
                </div>
                {p.code && (
                  <img
                ...
                <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                  {[
                    ...
                    ['Cap Pts', p.projected_captain_points],
                    ['Fixture', p.fixture],
                  ].map(([label, value]) => (
